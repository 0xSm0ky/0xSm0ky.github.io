...
The admin login page of a target application (submitted via [IssueHunt](https://issuehunt.io/reports/00b123a0-fb62-42aa-84d0-50a15d85b0f9)) loaded **jQuery 3.2.1** directly from the Google CDN. That version is affected by two separate issues:
...
Full report and disclosure timeline: [IssueHunt report](https://issuehunt.io/reports/00b123a0-fb62-42aa-84d0-50a15d85b0f9).
